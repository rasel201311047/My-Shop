    ...
    <SafeAreaView className="h-screen">
      ...
      <View className='top-14 px-3'>
        ...
        <View className='px-4'>
          ...
          <TouchableOpacity onPress={() => router.push('/edit')} className='bg-[#23AA49] mt-10 py-3 rounded-full'>
            <Text className='text-lg text-white font-bold text-center'>Edit</Text>
          </TouchableOpacity>
        </View>
